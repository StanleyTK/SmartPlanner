...
from .views import CreateTaskView, UpdateTaskView, DeleteTaskView, GetTasksView, GetTasksByDateView, FilterTasksView
...
urlpatterns = [
    ...
    path('filter/', FilterTasksView.as_view(), name='filter_tasks'),
